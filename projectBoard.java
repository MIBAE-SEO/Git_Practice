...
private void initialize() {
		...
		ImagePanel welcomePanel = new ImagePanel(
				new ImageIcon("C:/Users/MIBAE/eclipse-workspace/JavaEx/image/welcome.jpg").getImage());
		...
		// 회원가입패널(두번째패널)
		ImagePanel mainpanel1 = new ImagePanel(
				new ImageIcon("C:/Users/MIBAE/eclipse-workspace/JavaEx/image/mainPanel.jpg").getImage());
		...
		// 마지막패널
		JPanel listPanel = new ImagePanel(
				new ImageIcon("C:/Users/MIBAE/eclipse-workspace/JavaEx/image/mainPanel02.jpg").getImage());
		...
		String[] title = { "Name", "Birth", "Phone", "Email" };
		
		for (int i = 0; i < list.size(); i++) {
			data[i][0] = list.get(i).getNameTxt();
			data[i][1] = list.get(i).getBirthTxt();
			data[i][2] = list.get(i).getPhoneTxt();
			data[i][3] = list.get(i).getEmailTxt();
		}
		DefaultTableModel dtm = new DefaultTableModel(data,title);
		table_1 = new JTable(dtm);
		listPanel.add(table_1);
		table_1.setBounds(50, 96, 417, 339);
	}
