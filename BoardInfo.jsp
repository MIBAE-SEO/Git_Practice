...
<%
	...
	int num = Integer.parseInt(request.getParameter("num").trim()); //공백제거후 정수형으로 바꿔준다.

	//데이터베이스 접근 
	BoardDAO bdao = new BoardDAO();
	
	//하나의 게시글을 리턴 받는다(BoardBean이용) 
...
%>
	...
	<tr height="40">
		...
		<td align="center" width="100"><%=bean.getNum() %></td>
		<td align="center" width="120">조회수</td>
		<td align="center" width="100"><%=bean.getReadcount() %></td>
	</tr>
